...
public class shortcut_edit extends Activity {
...
// Apply the adapter to the spinner
    ...
    public void VenueLists() {
        ...
        VenueList.remove(text1);
        VenueList.add(0,text1);
    ...
    public void Edit(View v)
    {
        ...
        if (name == "" || destination == "---Select---") {
            Toast.makeText(shortcut_edit.this, "Please enter the right informantion", Toast.LENGTH_SHORT).show();
        }
        else{
